...
struct msm_rtb_state msm_rtb = {
	...
	.enabled = 0,//ASUSDEBUG default 0 jeffery_hu@asus.com
};
...
int msm_rtb_probe(struct platform_device *pdev)
{
	 ...
	 */
	msm_rtb.phys = RTB_BUFFER;//ASUSDEBUG jeffery_hu@asus.com
	...
	// don't set the content to 0 //ASUSDEBUG jeffery_hu@asus.com
	// we need the last rtb log before reset //ASUSDEBUG jeffery_hu@asus.com
	//~ memset(msm_rtb.rtb, 0, msm_rtb.size);//ASUSDEBUG jeffery_hu@asus.com
